...
class Request
{
    ...
    private ?\DateTimeInterface $date_fullfilled = null;
    ...
    public function getDateFullfilled(): ?\DateTimeInterface
    {
        return $this->date_fullfilled;
    }

    public function setDateFullfilled(?\DateTimeInterface $date_fullfilled): self
    {
